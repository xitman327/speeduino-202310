  ...
  switch (currentCommand)
  {
    ...
    */
    ...
    case '?':
      ...
      case 'D':
      Serial.println(getReadableLogEntry(Serial.parseInt()));
      break;
...
void sendPageASCII(void)
{
  switch (currentPage)
  {
    ...
    case progOutsPage:
      Serial.println(F("\nPage 13 Cfg"));
      serial_println_range((byte *)&configPage13, (byte *)&configPage13 + sizeof(configPage13));
      break;
    ...
    default:
        ...
        Serial.println(F(" has not been implemented yet"));
    #endif
        break;
  }
}
